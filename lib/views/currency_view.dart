  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        ...
        BlocProvider<NetworkBloc>(create: (context) => locator<NetworkBloc>()),
      ],
      child: CurrencyView(),
    );
  }
        ...
        body: BlocListener<NetworkBloc, NetworkState>(
          listener: (context, state) {
            if (state is NetworkReEnabled) {
              context.read<CurrencyBloc>().add(InitializedAppCurrencyEvent());
              ScaffoldMessenger.of(context).showSnackBar(
                SnackBar(
                  content: Text(context.tr('you_are_online')),
              ...
              Positioned(
                ...
                child: BlocBuilder<NetworkBloc, NetworkState>(
                  builder: (context, netState) {
                    if (netState is NetworkDisabled) {
                      return Container(
                    ...
                    return const SizedBox.shrink(); // Mạng ngon thì ẩn đi
                  },
                ),
              ),
            ],
