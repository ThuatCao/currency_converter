...
Future<void> setupDependencies() async{
  ...
  locator.registerFactory<CurrencyBloc>(() => CurrencyBloc(db: locator<AppDatabase>(), dioClient: locator<DioClient>()));
  
  locator.registerFactory<CurrencyConverterBloc>(() => CurrencyConverterBloc(database: locator<AppDatabase>()));
}
